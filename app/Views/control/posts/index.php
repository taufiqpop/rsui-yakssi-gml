                            ...
                            <tbody>
                                <?php foreach ($posts as $index => $post) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $post['tag']; ?></td>
                                        <td>
                                            <a href="<?= base_url(); ?>control/posts/detail/<?= $post['id']; ?>" class="btn btn-info mb-1"><i class="fas fa-info mb-1"></i></a>
                                            <a href="<?= base_url(); ?>control/posts/edit/<?= $post['id']; ?>" class="btn btn-warning mb-1"><i class="fas fa-edit mb-1"></i></a>
