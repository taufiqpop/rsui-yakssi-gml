            ...
            <div class="row card shadow mb-4">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="cursor-active">Blok</th>
                                    <th scope="col" class="cursor-active">Tipe</th>
                                    <th scope="col" class="cursor-active">Content</th>
                                    <th scope="col" class="cursor-stop">Form</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <?php foreach ($beranda as $beranda) : ?>
                                    <tr>
                                        <th scope="row"><?= $i++; ?></th>
                                        <td>
                                            <img src="<?= base_url(); ?>img/<?= $beranda['images']; ?>" class="thumbnail">
                                        </td>
                                        <td><?= $beranda['blok']; ?></td>
                                        <td><?= $beranda['tipe']; ?></td>
                                        <td><?= $beranda['content']; ?></td>
                                        <td>
                                            <a href="<?= base_url(); ?>control/beranda/details/<?= $beranda['id']; ?>" class="btn btn-info"><i class="fas fa-info"></i></a>
                                            <a href="<?= base_url(); ?>control/beranda/edit/<?= $beranda['id']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                        ...
                        <?= $pager->links('beranda', 'beranda_pagination'); ?>
                    </div>
                </div>
            </div>
        </div>
