...
<div class="container-fluid">
    <div class="row">
        <div class="col-11">
            <h1 class="h3 mb-4 text-gray-800">Daftar Widget</h1>
            <a href="<?= base_url(); ?>control/widget/form" class="btn btn-primary">Add Widget</a>
            <br><br>
            ...
            <div class="row card shadow mb-4">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="cursor-active">Subjudul</th>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($widget as $widget) : ?>
                                    <tr>
                                        <th scope="row"><?= $i++; ?></th>
                                        <td>
                                            <img src="<?= base_url(); ?>img/<?= $widget['images']; ?>" class="thumbnail">
                                        </td>
                                        <td><?= $widget['judul']; ?></td>
                                        <td><?= $widget['subjudul']; ?></td>
                                        <td><?= $widget['link']; ?></td>
                                        <td><?= $widget['created_at']; ?></td>
                                        <td><?= $widget['updated_at']; ?></td>
                                        <td>
                                            <a href="<?= base_url(); ?>control/widget/details/<?= $widget['id']; ?>" class="btn btn-info"><i class="fas fa-info"></i></a>
                                            <a href="<?= base_url(); ?>control/widget/formEdit/<?= $widget['id']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                        ...
                        <?= $pager->links('widget', 'widget_pagination'); ?>
                    </div>
                </div>
            </div>
        </div>
