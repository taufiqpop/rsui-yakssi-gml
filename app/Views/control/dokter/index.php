...
<div class="container-fluid">
    <div class="row">
        <div class="col-11">
            <h1 class="h3 mb-4 text-gray-800">Daftar Dokter</h1>
            <a href="<?= base_url(); ?>control/dokter/form" class="btn btn-primary">Add Dokter</a>
            <br><br>
                            ...
                            <tbody>
                                <?php foreach ($dokter as $index => $doctor) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url(); ?>control/dokter/edit/<?= $doctor['id']; ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
