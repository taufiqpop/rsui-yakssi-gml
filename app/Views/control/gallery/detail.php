                        ...
                        <div class="col-md-6">
                            ...
                            <center>
                                ...
                                <div class=" container tombol-detail">
                                    <a href="<?= base_url(); ?>control/gallery" class="btn btn-dark col-3"><i class="fas fa-arrow-left"></i></a>
                                    <a href="<?= base_url(); ?>control/gallery/edit/<?= $galeri['id']; ?>" class="btn btn-warning col-3"><i class="fas fa-edit"></i></a>
